...
<?php 
  ...
  if(isset($_POST['save'])){
    ...
    $update="UPDATE recomandare SET Denumire='$denumire' WHERE IDRecomandare='$id'";
  ...
  $query="SELECT Denumire FROM recomandare WHERE IDRecomandare='$id'";
  ...
  <div class="row">
      ...
      <div class="col-sm-6">
        ...
        <form action=updaterecomandare.php method=POST>
          <div class="form-group">
            <label for="attribute8">Denumire</label>
            <input type="text" class="form-control" id="attribute8" name=denumire value='.$n.'>
          </div>
