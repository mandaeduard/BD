...
//operatii pe tabela hrana
  ...
  //terminare operatii pentru tabela hrana
//operatii pe tabela producator
  ...
  //terminare operatii pentru tabela producator
...
//terminare operatii tabela manager
...
//operatii pe tabela recomandare
  ...
  if(isset($_POST['saverecomandare'])){
    $denumire=$_POST['denumire'];
...
//terminare operatii pe tabela recomandare

//operatii pe tabela hrana-recomandare
  //stergere hrana recomandare
...
//terminare operatii pentru tabela ingredient
      ...
      <div class="col-sm-6">
        ...
        <form action=informatii.php method=POST>
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="attribute21" name=ingredient>
          </div>
          <div class="form-group">
            <label for="attribute25">Procent</label>
            <input type="text" class="form-control" id="attribute21" name=procent>
          </div>
